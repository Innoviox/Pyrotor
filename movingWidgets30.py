...
class Player():
    ...
    def scoreAnimation(self, scoreLabel, startX, startY, endX, endY, endWidth, endHeight, travelTime = .1, changesPerSecond = 100):
...
##                                               25, 25, endWidth, endHeight)):
        ...
        for scoreChange in range(scoreLabel):
            self.player1ScoreLabel.config(text=self.score + scoreChange)
    ...
    def resetBoard(self, *popup, *popupHeader, *popupText):
##        if popup:
