...
class MovingLetter():
    ...
    ['15', 'TWS', ' ', ' ', 'DLS', ' ', ' ', ' ', 'TWS', ' ', ' ', ' ', 'DLS', ' ', ' ', 'TWS']]
        ...
        self.label = Label(self.frame, bd=1, relief=RAISED, text=text, height=31, width=31, bg="yellow")
    ...
    def setBlank(self, letter):
        ...
        self.text = letter
        self.label.destroy()
        self.label = Label(self.frame, bd=1, relief=RAISED, text=self.text, height = 31, width = 31)
        self.label.pack(fill=X, padx=1, pady=1)
