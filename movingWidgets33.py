...
##        for movable in self.movables:
##            tempWordIndexes = {}
##            for key in movable.wordIndexes.keys():
##                tempWordIndexes[key] = movable.wordIndexes[key]
##                
##            for (word, index) in tempWordIndexes.items():
##                if word != sharedWord:
##                    movable.wordIndexes.pop(word)


        print(movable.wordIndexes)
        for movable in self.movables:
            if movable.row != "NA":
                movable.wordIndex = movable.wordIndexes[sharedWord]
