...
##                self.setBlank("?")
    ...
    def chooseBlank(self):
        ...
        self.choiceWindow = Frame(self.blankWindow, relief = RAISED)
        self.choiceWindow.place(x=300, y=300, width=120, height = 100)
        buttons = []
        row = 1
        column = 1
        for letter in string.ascii_uppercase:
            button = Button(self.blankWindow, text = letter,
...
distribution = ["a", "a", "a", "a", "a", "a", "a", "a", "a", \
                    ...
                    "r", "r", "r", "r", "r", "r", "s", "s", "s", "s", \
                    "t", "t", "t", "t", "t", "t", "u", "u", "u", "u", \
                    "v", "v", "w", "w", "x", "y", "y", "z", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?", "?"] #"?" is a blank tile, can be any letter.
class Game():
