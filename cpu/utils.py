...
regBoard = [[' ', 'A ', 'B ', 'C ', 'D ', 'E ', 'F ', 'G ', 'H ', 'I ', 'J ', 'K ', 'L ', 'M ', 'N ', 'O '], ['01', 'F', 'A', 'T', 'DLS', 'A', 'X', 'E', 'D', ' ', ' ', ' ', 'DLS', ' ', ' ', 'TWS'], ['02', ' ', 'T', 'O', 'A', 'D', 'TLS', ' ', ' ', ' ', 'TLS', ' ', ' ', ' ', 'DWS', ' '], ['03', ' ', ' ', 'DWS', 'L', 'O', 'O', 'N', ' ', 'DLS', ' ', ' ', ' ', 'G', ' ', ' '], ['04', 'DLS', ' ', ' ', 'I', ' ', 'P', 'U', 'B', ' ', ' ', ' ', 'DWS', 'L', ' ', 'DLS'], ['05', ' ', ' ', ' ', 'E', 'N', ' ', 'N', 'O', 'I', 'S', 'Y', ' ', 'U', ' ', ' '], ['06', ' ', 'TLS', ' ', 'N', 'E', 'T', ' ', ' ', ' ', 'H', ' ', 'W', 'E', 'TLS', ' '], ['07', ' ', ' ', 'DLS', ' ', 'G', 'O', 'DLS', ' ', 'Q', 'I', ' ', 'U', 'DLS', ' ', ' '], ['08', 'TWS', ' ', ' ', 'DLS', ' ', 'L', ' ', 'R', 'A', 'V', 'E', 'D', ' ', ' ', 'TWS'], ['09', ' ', ' ', 'DLS', ' ', ' ', 'E', 'DLS', ' ', 'T', 'A', 'V', ' ', 'DLS', ' ', ' '], ['10', ' ', 'TLS', 'N', 'O', 'I', 'S', 'E', ' ', ' ', 'H', 'I', ' ', ' ', 'TLS', 'K'], ['11', ' ', ' ', ' ', ' ', 'DWS', ' ', ' ', ' ', ' ', ' ', 'C', ' ', ' ', 'S', 'I'], ['12', 'DLS', ' ', ' ', 'DWS', ' ', ' ', ' ', 'W', 'A', 'L', 'T', 'Z', ' ', 'E', 'DLS'], ['13', ' ', ' ', 'B', 'A', 'R', 'M', 'I', 'E', 'R', ' ', 'S', 'A', 'N', 'E', 'R'], ['14', ' ', 'DWS', 'I', 'D', 'E', 'M', ' ', 'N', ' ', 'TLS', ' ', ' ', ' ', 'P', 'A'], ['15', 'F', 'O', 'G', 'DLS', ' ', ' ', ' ', 'T', ' ', ' ', ' ', 'DLS', ' ', ' ', 'J']]
...
class Board():
    ...
    def checkWord(self, word):
        ...
        if '?' in word:
            return any(checkWord(word.replace('?', i)) for i in string.ascii_uppercase)
        return word in subdicts[word[:2]]
    ...
    def score(self, move):
        if self.words[1] == self.board:
            oldWords = self.words[0]
        else:
